...
public class PyOrNode extends PyExpressionNode{
    @Child private PyExpressionNode left;
    @Child private PyExpressionNode right;
    private final ConditionProfile evaluateRightProfile = ConditionProfile.createCountingProfile();

    public PyOrNode(PyExpressionNode left, PyExpressionNode right) {
        this.left = left;
        this.right = right;
    }
